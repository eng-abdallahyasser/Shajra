  ...
  static void _showTreeProfile(BuildContext context, TreeData tree, List<ZoneData> zones) {
    ...
    Get.bottomSheet(
      _ProfileSheetContent(
        ...
        title: tree.id,
        subtitle: 'details_tree_profile'.tr,
        cs: cs,
        rows: [
          _InfoRowData(icon: Icons.tag, label: 'add_gh_micro_tag'.tr, value: tree.id),
          _InfoRowData(icon: Icons.qr_code, label: 'add_gh_greenhouse'.tr, value: ghNumber.isNotEmpty ? 'GH #$ghNumber' : '—'),
          _InfoRowData(icon: Icons.view_in_ar, label: 'add_gh_zone'.tr, value: tree.zoneId != null ? '$zoneName (${tree.zoneId})' : 'add_gh_not_assigned'.tr),
          _InfoRowData(icon: Icons.my_location, label: 'add_gh_position'.tr, value: '(${tree.x}, ${tree.y}) m'),
        ],
      ),
  ...
  static void showZoneProfile(BuildContext context, String zoneId, String zoneName, int treeCount) {
    ...
    Get.bottomSheet(
      _ProfileSheetContent(
        ...
        iconColor: cs.primary,
        title: zoneName,
        subtitle: 'details_zone_profile'.tr,
        cs: cs,
        rows: [
          _InfoRowData(icon: Icons.tag, label: 'add_gh_micro_tag'.tr, value: zoneId),
          _InfoRowData(icon: Icons.qr_code, label: 'add_gh_greenhouse'.tr, value: ghNumber.isNotEmpty ? 'GH #$ghNumber' : '—'),
          _InfoRowData(icon: Icons.eco, label: 'add_gh_trees_in_zone'.tr, value: '$treeCount'),
        ],
      ),
      isScrollControlled: true,
      enableDrag: true,
  ...
  static void _showZoneProfile(BuildContext context, ZoneData zone, List<TreeData> trees) {
    ...
    Get.bottomSheet(
      _ProfileSheetContent(
        ...
        cs: cs,
        rows: [
          _InfoRowData(icon: Icons.tag, label: 'add_gh_micro_tag'.tr, value: zone.id),
          _InfoRowData(icon: Icons.qr_code, label: 'add_gh_greenhouse'.tr, value: ghNumber.isNotEmpty ? 'GH #$ghNumber' : '—'),
          _InfoRowData(icon: Icons.eco, label: 'add_gh_trees_in_zone'.tr, value: '$treeCount'),
          _InfoRowData(icon: Icons.straighten, label: 'add_gh_dimensions'.tr, value: '${zone.width}m × ${zone.height}m'),
          _InfoRowData(icon: Icons.my_location, label: 'add_gh_position'.tr, value: '(${zone.left}, ${zone.top}) m'),
        ],
      ),
      isScrollControlled: true,
      enableDrag: true,
